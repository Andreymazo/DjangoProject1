...
from catalog.views import products, contact_us, RecordListView, RecordCreateView, RecordUpdateView, RecordDeleteView, \
    RecordDetailView, ProductListView, ProductUpdateView  # , RecordCreateView, crab1,ProductCreateView,
...
urlpatterns = [
    ...
    # path('create_products/', ProductCreateView.as_view(), name='Product_list'),
    path('create_products/', ProductListView.as_view(), name='Product_list'),
